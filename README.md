...
<p align="center">
  <a href="#上游项目"><img src="https://img.shields.io/badge/upstream-nearai%2Fironclaw-181717.svg" alt="Upstream: nearai/ironclaw" /></a>
...
> **社区维护版本** — `ironclaw-zh` 是基于 [nearai/ironclaw](https://github.com/nearai/ironclaw) 的社区维护发行版，重点面向中文体验、本地优先部署和对上游安全架构的保留。本项目不是 NEAR AI 官方发行版。
...
访问 [Releases 页面](https://github.com/justinhuangcode/ironclaw-zh/releases/) 查看最新版本。

<details>
  <summary>通过 Windows 安装程序安装 (Windows)</summary>

下载 [Windows 安装程序](https://github.com/justinhuangcode/ironclaw-zh/releases/latest/download/ironclaw-x86_64-pc-windows-msvc.msi) 并运行。
...
- [项目概览](docs/zh-Hans/overview.md)
- [安装指南](docs/zh-Hans/install.md)
- [配置指南](docs/zh-Hans/configuration.md)
- [部署指南](docs/zh-Hans/deployment.md)
- [安全说明](docs/zh-Hans/security.md)
- [技能说明](docs/zh-Hans/skills.md)
...
- 当前包版本：`0.16.1-zh.1`
- 当前推荐发行标签：`v0.16.1-zh.1`

### 上游项目

上游项目：[nearai/ironclaw](https://github.com/nearai/ironclaw)

本仓库基于上游 IronClaw 维护，通用修复会尽量优先回提上游。
